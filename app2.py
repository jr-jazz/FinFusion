...
@st.cache_resource
def load_models():
    feature_scaler = joblib.load(r"C:\Users\sam4s\Desktop\FinFusion\models\feature_scaler.pkl")
    target_scaler = joblib.load(r"C:\Users\sam4s\Desktop\FinFusion\models\target_scaler.pkl")
    ...
    model = StockLSTM()
    model.load_state_dict(torch.load(r"C:\Users\sam4s\Desktop\FinFusion\models\final_multimodal_fixed.pth", map_location="cpu"))
    model.eval()

    xgb_model = joblib.load(r"C:\Users\sam4s\Desktop\FinFusion\models\xgboost_model.pkl")
